...
def reserva_seguridad(reserva_seguridad_fija):
...
reserva_seguridad_fija = float(input("Ingrese la cantidad de litros de combustible de reserva del avión: "))
limite_peso = float(input("Ingrese el peso máximo que puede cargar el avión: "))
precio_por_litro = float(input("Ingrese el coste del combustible por litro: "))
...
for i in range (1, vuelos+1, 1):
    ...
    reserva_seguridad_fija = reserva_seguridad(reserva_seguridad_fija)
